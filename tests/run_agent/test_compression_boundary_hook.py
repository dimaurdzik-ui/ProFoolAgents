...
old_session_id=<old>). This lets plugin engines (e.g. pixel-agents-lcm) preserve
DAG lineage across the split instead of treating it as a fresh /new.

See pixel-agents-lcm#68: after Pixel Agents compresses and mints a new physical session,
