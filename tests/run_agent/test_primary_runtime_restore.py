...
5. Recovery is skipped for aggregator providers (OpenRouter, Pixel)
...
class TestTryRecoverPrimaryTransport:
    ...
    def test_allowed_for_pixel_anthropic_messages(self):
        ...
        agent._primary_runtime.update({
            ...
            "anthropic_base_url": "https://inference-api.pixelagents.com/v1",
