...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("pixel_cli.config.get_config_path", return_value=config_path), \
             patch("pixel_cli.config.ensure_pixel_home"):
    ...
    def test_ensure_pixel_home_sets_0700(self):
        home = Path(self.tmpdir) / ".pixel-agents"
