...
The unit tests in tests/pixel_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned pixel-agents-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/pixel-agents")
from pixel_cli.service_manager import S6ServiceManager
