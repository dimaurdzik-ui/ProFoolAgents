...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and pixel-agents
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # pixel-agents (tests/skills/)
]
