...
class TestRealWorldOutput:
    ...
    REAL = (
        ...
        "Uploaded pixel-agents-temp-hello (0.74 sec)\n"
        "Deployed pixel-agents-temp-hello triggers (0.42 sec)\n"
        "  https://pixel-agents-temp-hello.serene-temple.workers.dev\n"
    )
    ...
    def test_all_fields_from_real_output(self):
        r = pdo.parse(self.REAL)
        assert r["live_url"] == "https://pixel-agents-temp-hello.serene-temple.workers.dev"
