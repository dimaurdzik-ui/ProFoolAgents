...
and the ``pixel-agents kanban repair`` CLI verb."""
...
# ---------------------------------------------------------------------------
# repair_db() API + `pixel-agents kanban repair` CLI verb
# ---------------------------------------------------------------------------

def _run_kanban_cli(argv: list[str]) -> int:
    """Drive the real argparse surface exactly like `pixel-agents kanban …`."""
    import argparse

    from pixel_cli import kanban as kc
...
def cli_home(tmp_path, monkeypatch):
    """Isolated PIXEL_AGENTS_HOME so kanban_db_path() resolves inside tmp_path."""
