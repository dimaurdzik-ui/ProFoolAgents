"""Tests for `pixel-agents curator status` output.
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated PIXEL_AGENTS_HOME with real agent-created skills on disk."""
    ...
    from pixel_cli import curator as curator_cli
