...
Simulates a slow pixel_cli.gateway import (15-30 s on a fresh Windows install
...
1. _lifespan synchropixel warmup: patched _warm_gateway_module sleeps N seconds;
...
import pixel_cli.web_server as web_server_mod
...
# ---------------------------------------------------------------------------
# Test 1 — _lifespan synchropixel warmup blocks startup (intentional)
# ---------------------------------------------------------------------------

def test_lifespan_warmup_is_synchropixel():
    """
    _warm_gateway_module runs synchropixelly before the lifespan yield (#73083).
    ...
    # Startup must block for at least SLOW_SECONDS (the import runs synchropixelly).
