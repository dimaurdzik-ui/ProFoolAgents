...
The notice prints the most recent curator run summary on `pixel-agents update`,
...
session start) so users normally never see the rename map. `pixel-agents update`
