"""Regression: ``pixel-agents update`` should take a managed checkout off autocrlf=true.
...
``pixel-agents update`` has to repair them.
...
from pixel_cli.update_cmd import _normalize_managed_eol
