"""Tests for ``pixel_cli.voice`` — the TUI gateway's voice wrapper.
...
class TestNormalizeVoiceRecordKeyForPromptToolkit:
    ...
    def test_non_string_falls_back_to_default(self):
        from pixel_cli.voice import normalize_voice_record_key_for_prompt_toolkit
    ...
    # parser rejects alt+c/d/l because pixel-agents-ink reports Alt as
...
class TestVoiceRecordKeyFromConfig:
    ...
    def test_missing_record_key_returns_none(self):
        from pixel_cli.voice import voice_record_key_from_config
...
class TestSpeakTextGuards:
    ...
    def test_speak_text_uses_returned_tts_file_path(self, monkeypatch):
        ...
        played = []
        returned_path = "/tmp/pixel_voice/actual.flac"
