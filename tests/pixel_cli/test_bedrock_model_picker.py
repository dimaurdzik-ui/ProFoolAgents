...
Covers the three paths changed by fix/bedrock-provider-model-ids-live-discovery:
  ...
  2. list_authenticated_providers() Section 2 (PIXEL_AGENTS_OVERLAYS) — bedrock
...
# ---------------------------------------------------------------------------
# 2. list_authenticated_providers() — bedrock via PIXEL_AGENTS_OVERLAYS (Section 2)
# ---------------------------------------------------------------------------
...
class TestBedrockOverlayRegistration:
    """bedrock entry in PIXEL_AGENTS_OVERLAYS is correctly configured."""

    def test_bedrock_overlay_exists(self):
        from pixel_cli.providers import PIXEL_AGENTS_OVERLAYS
        assert "bedrock" in PIXEL_AGENTS_OVERLAYS
