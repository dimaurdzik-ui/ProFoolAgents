...
def test_copilot_runtime_api_mode_uses_target_model_over_stale_config_default(monkeypatch):
    ...
    monkeypatch.setattr(
        "pixel_cli.models.copilot_model_api_mode",
...
@pytest.mark.parametrize("credential_source", ["pool", "explicit", "env", "pixel-agents-auth-store"])
