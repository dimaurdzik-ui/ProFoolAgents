"""Tests for ``pixel-agents approvals suggest`` (pixel_cli/approvals_suggest.py).

Approval history in Pixel Agents is implied, not ledgered: the session DB
...
from pixel_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
