"""Tests for `pixel-agents secrets bitwarden token` / `pixel-agents secrets onepassword token`.
...
from pixel_cli import onepassword_secrets_cli as op_cli
from pixel_cli import secrets_cli as bw_cli
