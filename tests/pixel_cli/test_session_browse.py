"""Tests for the interactive session browser (`pixel-agents sessions browse`).
...
from pixel_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """pixel-agents sessions browse should be parseable."""
