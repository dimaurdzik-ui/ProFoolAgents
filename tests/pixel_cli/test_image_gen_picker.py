...
class TestConfigWriting:
    ...
    def test_plugin_provider_active_overrides_managed_pixel_active_label(self, monkeypatch):
        from pixel_cli import tools_config
        ...
        monkeypatch.setattr(
            ...
            lambda config, **kwargs: SimpleNamespace(
                features={"image_gen": SimpleNamespace(managed_by_pixel=True)}
            ),
        )
        ...
        assert tools_config._is_provider_active(pixel_row, config) is False
