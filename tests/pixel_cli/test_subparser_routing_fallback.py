...
The main() function in pixel_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `pixel-agents -c model`
...
def _build_parser():
    """Build a minimal replica of the pixel-agents top-level parser."""
