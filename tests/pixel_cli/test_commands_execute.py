...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`pixel_cli.slash_exec.EXECUTORS`, and
...
from pixel_cli.commands import COMMAND_REGISTRY, resolve_command
from pixel_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,
