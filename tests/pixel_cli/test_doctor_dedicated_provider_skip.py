"""Regression: pixel-agents doctor must not run a generic Bearer-auth health
...
with HTTP 404. The dedicated check at pixel_cli/doctor.py already covers
Anthropic with the right headers, so the pluggable profile must be
skipped by `_build_apikey_providers_list()`.

See: PixelResearch/pixel-agents#22346
"""
