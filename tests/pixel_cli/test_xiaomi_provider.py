...
class TestXiaomiCredentials:
    ...
    def test_resolve_credentials_reads_home_external_secret_scope(
        ...
        from pixel_cli import env_loader
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in PIXEL_AGENTS_OVERLAYS
        overlay = PIXEL_AGENTS_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify pixel-agents doctor recognizes Xiaomi env vars."""
