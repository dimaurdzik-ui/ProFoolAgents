...
class TestWsAuthOkGated:
    ...
    def test_rejection_audit_logs(self, gated_app, tmp_path, monkeypatch):
        ...
        from pixel_cli.dashboard_auth import audit as audit_mod
        ...
        # The audit module may write asynchropixelly through stdlib logging,
        # but flush is synchropixel. If the file doesn't exist yet, the
...
class TestWsHostOriginGuardOrigins:
    ...
    def test_explicit_non_loopback_file_origin_allowed(self, insecure_explicit_host_app):
        """Packaged Pixel Agents Desktop also uses file:// when connecting to a
