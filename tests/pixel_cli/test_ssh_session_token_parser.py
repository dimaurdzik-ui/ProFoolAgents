...
from pixel_cli.main import _read_ssh_session_token_file, cmd_dashboard
...
def test_token_file_rejects_symlink(tmp_path, monkeypatch):
    home = tmp_path / "home"
    token_dir = home / ".pixel-agents" / "desktop-ssh" / ("a" * 32)
    ...
    override = set_pixel_agents_home_override(home / ".pixel-agents")
    try:
        ...
        reset_pixel_agents_home_override(override)
