...
def _clear_cache():
    ...
    import pixel_cli.models as mod
...
class TestGetCopilotModelContext:
    ...
    @patch("pixel_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("pixel_cli.models.fetch_github_model_catalog", return_value=[])
