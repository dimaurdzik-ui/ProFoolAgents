"""Tests for the specifier module + `pixel-agents kanban specify` CLI surface.
...
from pixel_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `pixel-agents kanban …` argparse surface directly."""
