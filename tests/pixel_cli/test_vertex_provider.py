...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (pixel_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_pixel_overlays():
    """pixel_cli.providers.get_provider("vertex") backs
