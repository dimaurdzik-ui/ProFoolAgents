"""Tests for pixel_cli.copilot_auth — Copilot token validation and resolution."""
...
class TestResolveToken:
    ...
    def test_gh_cli_classic_pat_raises(self, monkeypatch):
        ...
        with patch("pixel_cli.copilot_auth._try_gh_cli_token", return_value="ghp_classic"):
...
class TestRequestHeaders:
    ...
    def test_default_headers_include_openai_intent(self):
        ...
        assert headers["User-Agent"] == "PixelAgentsAgent/1.0"
