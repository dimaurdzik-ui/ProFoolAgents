...
part of the bundled-plugins set; a stock pixel-agents install does not see
an "Example" tab in its sidebar. The ``_install_example_plugin`` pytest
fixture in ``tests/pixel_cli/test_web_server.py`` copies this directory
into ``$PIXEL_AGENTS_HOME/plugins/example-dashboard/`` and forces the dashboard
