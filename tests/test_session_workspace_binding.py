"""Session <-> workspace grouping key (pixel_state.workspace_key).

The key is what `pixel-agents sessions list --workspace` groups/filters on. It is a
...
from pixel_state import workspace_key
