...
class TestOneShotSSH:
    ...
    def test_state_does_not_persist(self):
        _run("export PIXEL_AGENTS_ONESHOT_TEST=yes")
        r = _run("echo $PIXEL_AGENTS_ONESHOT_TEST")
...
class TestPersistentSSH:
    ...
    def test_env_var_persists(self):
        _run("export PIXEL_AGENTS_PERSIST_TEST=works")
        r = _run("echo $PIXEL_AGENTS_PERSIST_TEST")
