...
class TestRunBrowserCommandPathConstruction:
    ...
    def test_subprocess_preserves_executable_path_with_spaces(self, tmp_path):
        ...
        browser_path = "/Users/test/Library/Application Support/pixel-agents/node_modules/.bin/agent-browser"
        pixel_home = str(tmp_path / "pixel-agents-home")
 ...
 patch("tools.browser_tool._chromium_installed", return_value=True), \
             ...
             patch("pixel_constants.Path.home", return_value=tmp_path), \
