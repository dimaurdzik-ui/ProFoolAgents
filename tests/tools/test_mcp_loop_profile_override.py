"""Regression tests for PIXEL_AGENTS_HOME override propagation onto the MCP loop.
...
get_pixel_agents_home() inside the coroutine, most visibly OAuth token-store
