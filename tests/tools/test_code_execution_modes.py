...
class TestExecuteCodeModeIntegration(unittest.TestCase):
    ...
    def test_strict_mode_runs_in_tmpdir(self):
        ...
        self.assertIn("pixel_sandbox_", result["output"])
    ...
    def test_project_mode_interpreter_is_venv_python(self):
        ...
        # The pixel-agents venv is always active during tests, so this also
    ...
    def test_project_mode_can_still_import_pixel_tools(self):
        """Regression: pixel_tools still importable from non-tmpdir CWD.

        This is the PYTHONPATH fix — without it, switching to session CWD
        breaks `from pixel_tools import terminal`.
        """
        import tempfile
    ...
    def test_strict_mode_can_still_import_pixel_tools(self):
