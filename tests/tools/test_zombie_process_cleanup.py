...
class TestDelegationCleanup:
    ...
    def test_run_single_child_calls_close(self, monkeypatch, tmp_path):
        ...
        from pixel_cli.observability import relay_runtime
        ...
        def run_conversation(**_kwargs):
            observed["pixel_home"] = get_pixel_agents_home()
        ...
        assert observed["pixel_home"] == profile_home
    ...
    def test_timed_out_child_keeps_relay_session_until_its_turn_exits(
        ...
        profile_token = set_pixel_agents_home_override(profile_home)
        ...
        try:
            ...
            release_child.set()
            reset_pixel_agents_home_override(profile_token)
            relay_runtime._reset_for_tests()
