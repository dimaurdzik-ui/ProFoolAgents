...
class TestGatingWithTarget:
    """``PIXEL_AGENTS_DISABLE_LAZY_INSTALLS=1`` must STOP blocking once a durable
...
@pytest.mark.skipif(
    os.environ.get("PIXEL_AGENTS_RUN_NETWORK_TESTS") != "1",
    reason="opt-in real-install test (set PIXEL_AGENTS_RUN_NETWORK_TESTS=1); CI runs "
