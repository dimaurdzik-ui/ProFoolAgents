...
def _make_socket_dir(tmpdir, session_name, pid=None, owner_pid=None):
    ...
    Args:
        ...
        owner_pid: owning pixel-agents PID to write to <session>.owner_pid
...
class TestOwnerPidCrossProcess:
    ...
    The owner_pid file records which pixel-agents process owns a daemon so that
    concurrent pixel-agents processes don't reap each other's active browser
