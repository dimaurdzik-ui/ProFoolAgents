...
def test_import_loads_env_from_pixel_home(tmp_path, monkeypatch):
    home = tmp_path / ".pixel-agents"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-pixel-agents-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-pixel-agents-home"
