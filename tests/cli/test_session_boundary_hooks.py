...
from pixel_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/pixel_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("pixel_cli.lifecycle.invoke_hook")
@patch("pixel_cli.lifecycle.finalize_session")
