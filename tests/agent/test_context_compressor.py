...
class TestAuthFailureAborts:
    ...
    Real incident: a pixel token pointed at a stale staging inference URL
    ...
    def test_missing_provider_api_key_preserves_original_messages(self):
        ...
        err = RuntimeError(
            ...
            "to a different provider with pixel-agents model."
        )
        with patch(
...
class TestTruncateToolCallArgsJson:
    ...
    def test_shrunken_args_remain_valid_json(self):
        ...
        original = _json.dumps({
            "path": "~/.pixel-agents/skills/shopping/browser-setup-notes.md",
        ...
        assert parsed["path"] == "~/.pixel-agents/skills/shopping/browser-setup-notes.md"
