...
class TestGenerateTitle:
    ...
    def test_title_language_reads_config(self):
        ...
        with patch("pixel_cli.config.load_config", return_value=cfg), patch("pixel_cli.config.load_config_readonly", return_value=cfg):
            assert _title_language() == "French"
        with patch("pixel_cli.config.load_config", return_value={}), patch("pixel_cli.config.load_config_readonly", return_value={}):
            assert _title_language() == ""
        with patch("pixel_cli.config.load_config", side_effect=RuntimeError("bad config")), \
         patch("pixel_cli.config.load_config_readonly", side_effect=RuntimeError("bad config")):
            assert _title_language() == ""
