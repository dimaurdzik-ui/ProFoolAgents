"""Tests for CodexEventProjector — codex item/* events → Pixel Agents messages list.
...
class TestRoleAlternationInvariant:
    ...
    one item — that breaks Pixel Agents' message alternation invariant."""
