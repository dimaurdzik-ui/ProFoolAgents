...
def test_state_row_index_maps_to_supported_atlas_taxonomies():
    ...
    # Legacy Pixel Agents/petdex sheets were 8 rows with Pixel Agents state names packed in
...
def boba_like(tmp_path, monkeypatch):
    """Install a synthetic 8-col × 9-row pet into a temp PIXEL_AGENTS_HOME."""
