...
AUD = "agent:inst-123"
ISS = "https://portal.pixelagents.com"
...
def test_jwks_url_path_resolves_key(rsa_keys, monkeypatch):
    ...
    class FakeJWKClient:
        def __init__(self, url):
            assert url == "https://portal.pixelagents.com/.well-known/jwks.json"
    ...
    claims = verify_nas_fire_token(
        ...
        jwks_or_key="https://portal.pixelagents.com/.well-known/jwks.json",
        issuer=ISS,
    )
