...
class TestMem0V3Tools:
    ...
    def _make_provider(self, monkeypatch, backend):
        ...
        provider._agent_id = "pixel-agents"
    ...
    def test_add_uses_content_param(self, monkeypatch):
        ...
        assert call[2]["agent_id"] == "pixel-agents"
...
class TestMem0Prefetch:
    """prefetch() must recall on the CURRENT question, synchropixelly.
    ...
    def test_queue_prefetch_fires_no_search(self):
        # prefetch is synchropixel now, so the post-turn warm is redundant and
