    ...
    with patch.dict("sys.modules", {
        ...
        with patch("subprocess.Popen") as mock_popen:
            ...
            worker = _SlashWorker(
                ...
                model="test-model",
                profile_home="/home/luke/.pixel-agents/profiles/work"
            )
            
            # Verify Popen was called
            assert mock_popen.called
            
            # Check that PIXEL_AGENTS_HOME was set in the environment
            call_kwargs = mock_popen.call_args[1]
            assert "env" in call_kwargs
            assert call_kwargs["env"]["PIXEL_AGENTS_HOME"] == "/home/luke/.pixel-agents/profiles/work"
