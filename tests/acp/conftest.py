...
Keeps the ACP server tests offline: ``PixelAgentsACPAgent._build_model_state``
calls ``pixel_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import pixel_cli.inventory as inventory
