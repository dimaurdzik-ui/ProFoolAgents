"""Tests for _setup_feishu() in pixel_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("pixel_cli.config.save_env_value", side_effect=mock_save), \
         patch("pixel_cli.config.get_env_value", side_effect=mock_get), \
         patch("pixel_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("pixel_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("pixel_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("pixel_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("pixel_cli.cli_output.print_header"), \
         patch("pixel_cli.cli_output.print_info"), \
         patch("pixel_cli.cli_output.print_success"), \
         patch("pixel_cli.cli_output.print_warning"), \
         patch("pixel_cli.cli_output.print_error"), \
