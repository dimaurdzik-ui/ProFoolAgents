...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("PIXEL_AGENTS_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("PIXEL_AGENTS_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("PIXEL_AGENTS_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
