...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.pixel-agents/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at pixel_state import time, before pytest's PIXEL_AGENTS_HOME monkeypatch
    fires — the autouse fixture's PIXEL_AGENTS_HOME override doesn't help here.)
    """
    import pixel_state
