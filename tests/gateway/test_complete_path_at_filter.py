...
def _reset_fuzzy_cache(monkeypatch):
    ...
    # via _load_cfg(), which resolves through _pixel_home captured at module
    # import time — before the per-test PIXEL_AGENTS_HOME redirect applies. When the
