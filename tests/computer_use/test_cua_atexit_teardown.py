...
caches it for the life of the Pixel Agents process. Nothing ever tore it down, so
the driver outlived the session that started it (#28152 item 3 — "Pixel Agents does
