...
def worker_loop(worker_id: int, pixel_home: str, result_file: str) -> None:
...
def reclaimer_loop(pixel_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="pixel_mixed_stress_")
    print(f"PIXEL_AGENTS_HOME = {home}")
