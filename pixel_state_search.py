...
class SessionSearchMixin:
    ...
    def search_messages(
        ...
        Threshold: PIXEL_AGENTS_SEARCH_SLOW_MS (default 1000; 0 logs every call).
        """
        started = time.time()
        rows = None
        try:
            ...
            try:
                threshold = float(os.getenv("PIXEL_AGENTS_SEARCH_SLOW_MS", "1000"))
    ...
    def search_sessions_by_id(
        ...
        a session id from logs, CLI output, or another Pixel Agents surface and jump
    ...
    def optimize_fts(self) -> int:
        ...
        disabled via ``PIXEL_AGENTS_DISABLE_FTS_TRIGRAM`` or not yet created), so
