# Streaming LLM Response Support for Pixel Agents
...
```
PIXEL_AGENTS_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("PIXEL_AGENTS_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `pixel_cli/config.py` | 1 | +streaming config defaults |
...
PIXEL_AGENTS_STREAMING_ENABLED=true
```
