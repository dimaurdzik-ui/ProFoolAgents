# nix/overlays.nix — Expose pkgs.pixel-agents for external NixOS configs
#
...
# `pkgs.pixel-agents`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    pixel-agents = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}
