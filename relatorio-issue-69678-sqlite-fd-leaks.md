...
**Repositório:** `PixelResearch/pixel-agents`  
**Issue principal:** [#69678 — SQLite connections leaked in delivery, async delegation, and verification evidence ledgers](https://github.com/PixelResearch/pixel-agents/issues/69678)  
**PR principal:** [#69681 — fix(gateway,tools,agent): close leaked SQLite connections in delivery](https://github.com/PixelResearch/pixel-agents/pull/69681)
...
[Issue #69567](https://github.com/PixelResearch/pixel-agents/issues/69567) encontrou a mesma falha em `cron/executions.py`. Uma execução normal de cron abre conexões em `create_execution()`, `mark_execution_running()` e `finish_execution()`. O relato mediu crescimento de descritores até atingir limite do processo.

[PR #69594](https://github.com/PixelResearch/pixel-agents/pull/69594) propõe um `_transaction()` que:
...
- [#69567](https://github.com/PixelResearch/pixel-agents/issues/69567): cron execution ledger;
- [#60859](https://github.com/PixelResearch/pixel-agents/issues/60859): leak de `SessionDB` em early return;
- [#30027](https://github.com/PixelResearch/pixel-agents/issues/30027): listagem de boards kanban;
- [#28802](https://github.com/PixelResearch/pixel-agents/issues/28802): helpers kanban specify;
- [#36111](https://github.com/PixelResearch/pixel-agents/issues/36111): lifecycle de `ResponseStore` no API server;
- [#37369](https://github.com/PixelResearch/pixel-agents/issues/37369): crescimento de descritores de `response_store.db`.
