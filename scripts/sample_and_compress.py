...
DEFAULT_DATASETS = [
    "PixelResearch/swe-terminus-agent-glm-kimi-minimax",
    "PixelResearch/pixel-agents-megascience-sft1",
    "PixelResearch/Pixel-Agents-Thinking-GLM-4.7-SFT2",
    "PixelResearch/Pixel-Agents-Thinking-GLM-4.7-SFT1",
    "PixelResearch/terminal-tasks-glm-pixel-agents"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "PixelResearch/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload PixelResearch/{output_name} {final_output}")
