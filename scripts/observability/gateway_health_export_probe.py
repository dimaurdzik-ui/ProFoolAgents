...
def main() -> None:
    ...
    pixel_home = Path(tempfile.mkdtemp(prefix="pixel-agents-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "pixel-agents-gateway-smoke",
    ...
    print(json.dumps({"pixel_home": str(pixel_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
