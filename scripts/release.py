...
VERSION_FILE = REPO_ROOT / "pixel_cli" / "__init__.py"
...
LEGACY_AUTHOR_MAP = {
    ...
    "pi@pixel-agents.local": "Elektrofussel",  # PR #61675 salvage (honcho: defaultHost + private-range local URL detection)
    ...
    "75556242+webtecnica@users.noreply.github.com": "webtecnica",  # PR #63360 salvage (pixel: restore inference-api base_url)
    ...
    "kavi@local.pixel-agents": "kavioavio",  # Issue #46544 / PR #47705 evolution (smart DENY exact-operation owner override)
    ...
    "sonxi@pixel.local": "17324393074",  # PR #53196 salvage (tools_config: known_plugin_toolsets null guard; commit under unlinked local identity)
    ...
    "sunsky.lau@gmail.com": "liuhao1024",  # PR #56993 salvage (gateway: process-level PIXEL_AGENTS_HOME for pid/lock/status identity files; #56986)
    ...
    "wyuebei@gmail.com": "wyuebei-cloud",  # PR #56640 salvage (pixel-agents journey: replace GNU-only %-d strftime with dt.day for Windows)
    ...
    "pixel-agents.wanderer@yahoo.com": "trismegistus-wanderer",  # PR #31856 salvage (gateway: defer idle-TTL agent-cache eviction until the session store says the session actually expired, so the expiry watcher can still fire MemoryProvider.on_session_end with the live transcript; #11205)
    ...
    "me@keslerm.com": "keslerm",  # PR #3459 salvage (gateway: 'log' tool_progress mode — silent in chat, tool calls appended to ~/.pixel-agents/logs/tool_calls.log via rotating handler; duplicate of #3458 by @dlkakbs who submitted 4 min earlier — both credited)
    ...
    "hodlclone@gmail.com": "HODLCLONE",  # PR #49351 salvage (Pixel Portal token resilience: rotate refresh tokens write-through to the source auth store in profile mode, skip Pixel fallback when no local token, sync gateway session model after fallback)
    ...
    "moonsong@pixelagents.local": "Tranquil-Flow",  # PR #52623 salvage (auxiliary Anthropic base_url host validation; #52608)
    ...
    "121278003+Cossackx@users.noreply.github.com": "Cossackx",  # PR #52528 salvage (Windows pixel-agents-shim resolution + prefer --update on recovery; #52378)
    ...
    "annguyenPixel@users.noreply.github.com": "annguyenPixel",
    "32201324+simpolism@users.noreply.github.com": "simpolism",
    "simpolism@gmail.com": "simpolism",
    "jake@pixelagents.com": "simpolism",
    ...
    "pixel-agents@marian.local": "Schrotti77",
    ...
    "annguyenPixel@users.noreply.github.com": "annguyenPixel",
    "285874597+annguyenPixel@users.noreply.github.com": "annguyenPixel",
    "perkintahmaz50@gmail.com": "devatnull",
    ...
    "teknium@pixelagents.com": "teknium1",
    ...
    "274096618+pixel-agents-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "mind-dragon@pixel.research": "Mind-Dragon",
    ...
    "shannon@pixelagents.com": "shannonsands",
    ...
    "pixel-agents@pixelagents.com": "PixelResearch",
    ...
    "pixel-agents@pixelhq.ai": "benbarclay",
    ...
    "ben@pixelagents.com": "benbarclay",
    ...
    "emozilla@pixelagents.com": "emozilla",
    ...
    "jonny@pixelagents.com": "yoniebans",
    "jake@pixelagents.com": "simpolism",
    ...
    "sberan@gmail.com": "sberan",  # PR #54494 salvage (--connect-timeout flag on pixel-agents mcp add)
    ...
    "pixel-agents@example.com": "shellybotmoyer",  # PR #18915 (bot-committed)
    ...
    "agent@pixel-agents.local": "jacdevos",
    ...
    "github@nadyaPixelAgents.anonaddy.com": "ruangraung",  # PR #42308
    ...
    "pixeleman666@gmail.com": "pixeleman666",  # PR #19088
    ...
    "sylw3st3rr@gmail.com": "Sylw3ster",  # salvage of #23252 (PIXEL_AGENTS_KANBAN_BOARD restore)
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (PIXEL_AGENTS_HOME inject)
    ...
    "sauravsejal40@gmail.com": "Saurav0989",  # PR #27071 (docs: pixel-agents-eval community link)
    ...
    "pixel-agentsagent26@gmail.com": "pixel-agentsagent26",  # PR #26438 (kimi model-name reasoning pad)
    "276067471+pixel-agentsagent26@users.noreply.github.com": "pixel-agentsagent26",
    ...
    "clement@pixelagents.com": "lemassykoi",  # PR #27042 (model-switch probe keyless providers)
    ...
    "vigo@pixel-agents": "hawknewton",  # PR #26294 (bedrock boto3 lazy_deps)
    ...
    "hex.pixel-agents@agentmail.to": "oseftg",
    ...
    "ethie@pixel": "ethernet8023",  # PR #29342 (TUI clipboard copy on linux/wayland)
    ...
    "kdkcfp@gmail.com": "slowtokki0409",  # PR #29025 (ignore local Pixel Agents runtime files)
    ...
    "2663402852@qq.com": "x1am1",  # PR #35098 (chown root-owned top-level PIXEL_AGENTS_HOME state files)
    ...
    "annguyen@pixelagents.com": "annguyenPixel",  # PR #52844 co-author
    ...
    "zhchl@pixel-agents.local": "8294",  # PR #50572 salvage (honor config context_length on banner)
...
def update_version_files(semver: str, calver_date: str):
    ...
    # Python package version. The desktop About panel reads the live Pixel Agents
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "pixel-agents@pixelagents.com"}
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/PixelResearch/pixel-agents",
    ...
    lines.append(f"# Pixel Agents v{semver} ({tag_name})")
    lines.append("")
    ...
    if first_release:
        ...
        lines.append("> for Pixel Agents. See below for everything included in this initial release.")
        lines.append("")
...
def main():
    parser = argparse.ArgumentParser(description="Pixel Agents Release Tool")
    ...
    print(f"{'='*60}")
    print("  Pixel Agents Release Preview")
    print(f"{'='*60}")
    ...
    if args.publish:
        ...
        tag_result = git_result(
            "tag", "-a", tag_name, "-m",
            f"Pixel Agents v{new_version} ({calver_date})\n\nWeekly release"
        )
        ...
        gh_cmd = [
            ...
            "--title", f"Pixel Agents v{new_version} ({calver_date})",
        ...
        if result and result.returncode == 0:
            ...
            print(
                f"    gh release create {tag_name} --title 'Pixel Agents v{new_version} ({calver_date})' "
