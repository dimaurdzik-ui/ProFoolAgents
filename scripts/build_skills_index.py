#!/usr/bin/env python3
"""Build the Pixel Agents Skills Index — a centralized JSON catalog of all skills.
...
`pixel-agents skills search/install` can use it without hitting the GitHub API.
...
# Ensure PIXEL_AGENTS_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Pixel Agents Skills Index...", flush=True)
