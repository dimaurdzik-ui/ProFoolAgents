...
must return the shape described below. All methods synchropixel; async is
...
class UIElement:
    ...
    # (trycua/cua#1961 — Surface 6 of PixelResearch/pixel-agents#47072).
...
class CaptureResult:
    ...
    # trycua/cua#1961 — Surface 7 of PixelResearch/pixel-agents#47072).
...
class ActionResult:
    ...
    verify → escalate ladder (PixelResearch/pixel-agents#67052). ``ok`` stays
