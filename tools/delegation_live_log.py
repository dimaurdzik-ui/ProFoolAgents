...
def live_transcript_root() -> Path:
    """Root directory for live transcripts (profile-safe, never ~/.pixel-agents)."""
    from pixel_constants import get_pixel_agents_dir

    return get_pixel_agents_dir("cache/delegation", "delegation_cache") / "live"
...
class LiveTranscriptWriter:
    ...
    def __init__(self, delegation_id: str, task_index: int, goal: str,
        ...
        try:
            ...
            header = [
                "=== Pixel Agents subagent live transcript ===",
