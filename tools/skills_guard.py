...
Trust levels:
  - builtin:   Ships with Pixel Agents. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.pixel-agents/\.env|\~/\.pixel-agents/\.env',
     "pixel_env_access", "critical", "exfiltration",
     "directly references Pixel Agents secrets file"),
    ...
    (r'\.pixel-agents/config\.yaml|\.pixel-agents/SOUL\.md',
     "pixel_config_mod", "critical", "persistence",
     "references Pixel Agents configuration files directly"),
...
# scan. `.skillignore` is the Pixel Agents-native name; `.clawhubignore` is honored
