...
Only included in the pixel-agents-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Pixel-Agents (https://github.com/PixelResearch/pixel-agents)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_pixel_agents_home() / "cache" / "discord_capabilities.json"
