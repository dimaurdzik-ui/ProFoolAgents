...
/**
 * E2E smoke tests for the packaged Pixel Agents desktop app.
 *
 ...
 * (credential stripping, isolated PIXEL_AGENTS_HOME + userData, unique app name).
 *
...
test('window opens with the Pixel Agents title', async () => {
