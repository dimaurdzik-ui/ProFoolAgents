...
const STORAGE_KEY = 'pixel-agents.desktop.layoutTree.v2'

writeKey('pixel-agents.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('pixel-agents.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('pixel-agents.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'pixel-agents.desktop.dismissedPanes.v1'
...
const USER_PLACED_KEY = 'pixel-agents.desktop.userPlacedPanes.v1'
...
if (import.meta.env.DEV && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__PIXEL_AGENTS_LAYOUT_TREE__ = {
    close: closeTreePane,
