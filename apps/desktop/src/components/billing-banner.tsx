 ...
 * usable — it only offers recovery: Pixel opens Settings → Billing in-app, other
...
export function BillingBanner({ sessionId }: { sessionId: null | string }) {
  ...
  const title = block.is_pixel ? copy.titlePixel : copy.titleProvider(block.provider_label)
