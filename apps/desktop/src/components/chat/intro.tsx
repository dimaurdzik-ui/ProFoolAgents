...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should Pixel Agents look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} Pixel Agents need to see?`,
    ...
    {
      headline: `What should ${label} Pixel Agents tackle?`,
...
const WORDMARK = 'PIXEL_AGENTS AGENT'
