 ...
 * `<pixel-agents home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'pixel-agents.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'pixel-agents.desktop.disabledPlugins.v1'
