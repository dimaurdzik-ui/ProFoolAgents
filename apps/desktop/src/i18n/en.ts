...
export const en: Translations = {
  ...
  boot: {
    ready: 'Pixel Agents Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Pixel Agents settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingPixelAgentsDesktop: 'Starting Pixel Agents Desktop…'
    },
    errors: {
      backgroundExited: 'Pixel Agents background process exited.',
      backgroundExitedDuringStartup: 'Pixel Agents background process exited during startup.',
    ...
    failure: {
      title: "Pixel Agents couldn't start",
      description:
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Pixel Agents backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updatePixelAgents: 'Update Pixel Agents',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Pixel Agents Desktop.',
    ...
    native: {
      ...
      inputBody: 'Pixel Agents is waiting for your response.',
      turnDoneTitle: 'Pixel Agents finished',
      turnDoneBody: '',
  ...
  billingBlock: {
    titlePixel: 'Out of Pixel credits',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Pixel Agents defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Pixel Agents is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Pixel Agents asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Pixel Agents was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    searchPlaceholder: {
      about: 'About Pixel Agents Desktop',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Pixel Agents follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Pixel Agents can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Pixel Agents is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Pixel Agents, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Pixel Agents checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Pixel Agents configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Pixel Agents.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Pixel Agents backend elsewhere. Per-profile overrides below.',
      ...
      envOverrideDesc:
        'Unset PIXEL_AGENTS_DESKTOP_REMOTE_URL and PIXEL_AGENTS_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Pixel Agents backend on localhost. This is the default and works offline.',
      inheritTitle: 'Use default gateway',
      inheritDesc: "Remove this profile's override and use the default connection.",
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Pixel Agents backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Pixel Agents Cloud',
      cloudDesc: 'Sign in once to Pixel Agents Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Pixel Agents Cloud',
      cloudSignIn: 'Sign in to Pixel Agents Cloud',
      cloudSignedIn: 'Signed in to Pixel Agents Cloud',
      cloudNeedsSignIn: 'Sign in to Pixel Agents Cloud to discover the agents on your account.',
      ...
      cloudNoAgents: {
        ...
        linkText: 'Pixel portal',
        after: ', then refresh.'
      },
      cloudRefresh: 'Refresh',
      cloudConnect: 'Connect',
      cloudConnecting: 'Connecting…',
      cloudDiscoverFailed: 'Could not load your Pixel Agents Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Pixel Agents Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Pixel Agents Cloud',
      cloudSignedOutMessage: 'Cleared the Pixel Agents Cloud session.',
      ...
      remoteUrlDesc:
        'Base URL for the remote dashboard backend. Path prefixes are supported, for example /pixel-agents.',
      ...
      restartingMessage: 'Pixel Agents Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Pixel Agents ${version}` : ''}`,
      ...
      sshDesc:
        'Pixel Agents is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshPixelAgentsPathTitle: 'Pixel Agents path (optional)',
      sshPixelAgentsPathDesc: 'Full path to the remote pixel-agents binary. Blank = auto-detect.',
      sshPixelAgentsPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Pixel Agents found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Pixel Agents runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Pixel Agents is not installed on the remote host. Install it there (curl -fsSL https://api.pixelagents.com/install.sh | sh) or set the Pixel Agents path.',
      sshErrPlatform:
        'Unsupported remote platform. Pixel Agents Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Pixel Agents on the remote host before connecting with Desktop SSH.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Pixel Agents runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Pixel Agents at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      pixelIncluded: 'Included with a Pixel subscription — sign in to Pixel Portal to activate.',
      pixelAuthNeededTitle: 'Sign in to Pixel Portal',
      pixelAuthNeededMessage: provider => `${provider} is saved but won't activate until you sign in to Pixel Portal.`,
      pixelAuthSignIn: 'Sign in',
      pixelAuthDoneTitle: 'Pixel Portal connected',
      pixelAuthDoneMessage: 'Your subscription backends are now active.',
      pixelAuthFailed: 'Pixel Portal sign-in did not complete',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via pixel-agents curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Pixel Agents builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  agents: {
    ...
    office: {
      title: 'AI office',
      subtitle: 'Persistent workers, autonomy controls, and completed work awaiting review.',
      live: 'Live',
      staff: 'Staff',
      review: 'Review',
      loading: 'Loading your AI office',
      loadFailed: 'Could not load the AI office',
      role: 'Role',
      chooseRole: 'Choose a role',
      name: 'Name',
      namePlaceholder: 'Worker display name',
      mode: 'Autonomy',
      manual: 'Manual',
      smart: 'Smart',
      autonomous: 'Autonomous',
      hire: 'Hire worker',
      noWorkers: 'No workers hired yet',
      noWorkersDesc: 'Choose a specialist and hire your first persistent AI employee.',
      pause: 'Pause',
      resume: 'Resume',
      archive: 'Archive',
      archiveConfirm: 'Archive this worker?',
      inboxEmpty: 'Review inbox is clear',
      inboxEmptyDesc: 'Controlled workers will place completed work here before it is accepted.',
      result: 'Result',
      feedback: 'Review feedback',
      feedbackPlaceholder: 'Explain what needs to change before rejecting…',
      feedbackRequired: 'Add feedback before rejecting the work.',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Pixel Agents to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Pixel Agents to generate pets.',
      backgroundHint: 'You can close this — Pixel Agents will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Pixel Agents desktop' },
    ...
    pixelAgentsActiveSessions: (version, count) => `Pixel Agents ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@pixel-agents:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Pixel Agents environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Pixel Agents will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Pixel Agents backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm:
        'This removes the saved project from Pixel Agents. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Pixel Agents...',
    placeholderReconnecting: 'Reconnecting to Pixel Agents…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give Pixel Agents a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'Pixel Agents will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    subagents: count => `${count} Agent${count === 1 ? '' : 's'}`,
    ...
    coding: {
      ...
      agentShip: 'Ask Pixel Agents to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Pixel Agents…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Pixel Agents…',
    ...
    unsupportedMessage: 'This version of Pixel Agents can’t update itself from inside the app.',
    ...
    manualBody:
      'You installed Pixel Agents from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Pixel Agents will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Pixel Agents desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Pixel Agents updater takes over in its own window and reopens Pixel Agents automatically when it’s done. Please don’t reopen Pixel Agents yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Pixel Agents reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Pixel Agents reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Pixel Agents needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Pixel Agents Desktop',
    setupChoiceDesc:
      'Connect this app to a Pixel Agents gateway you already run, or install Pixel Agents locally on this computer.',
    connectExistingTitle: 'Connect to existing Pixel Agents',
    ...
    installLocalTitle: 'Install Pixel Agents locally',
    installLocalDesc: 'Download Pixel Agents, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Pixel Agents Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Pixel Agents',
    remoteSetupDesc:
      'Enter your gateway URL. Pixel Agents Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Pixel Agents gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/pixel-agents',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Pixel Agents gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Pixel Agents',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Pixel Agents CLI or desktop instance is running. Stop any running Pixel Agents instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Pixel Agents",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Pixel Agents is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Pixel Agents…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Pixel Agents',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description:
          'Point Pixel Agents at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Pixel Agents connects automatically',
    ...
    authorizeThere: 'Authorize Pixel Agents there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Pixel Agents there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro models need a paid Pixel subscription.',
    free: 'Free',
    freeTier: 'Free tier',
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Pixel Agents Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Pixel Agents Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Pixel Agents will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Pixel Agents is restarting...',
      askRestart: 'Ask Pixel Agents to restart the server',
      lookingRestart: taskId => `Pixel Agents is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Pixel Agents is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message =>
        `Pixel Agents finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Pixel Agents could not restart the server.',
      stillWorking:
        'Pixel Agents is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Pixel Agents is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Pixel Agents gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.pixel-agents/config.yaml). Pixel Agents won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Pixel Agents needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Pixel Agents needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Pixel Agents Desktop to use Save Image.',
    restartToSaveImages: 'Restart Pixel Agents Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `pixel-agents gateway` running?'
    }
  },
