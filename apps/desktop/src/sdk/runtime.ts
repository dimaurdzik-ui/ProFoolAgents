 ...
 * plugins resolve `@pixel-agents/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __PIXEL_AGENTS_PLUGIN_SDK__: sdk,
  __PIXEL_AGENTS_REACT__: React,
  __PIXEL_AGENTS_REACT_JSX__: jsxRuntime,
  __PIXEL_AGENTS_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@pixel-agents/plugin-sdk': shimUrl('__PIXEL_AGENTS_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__PIXEL_AGENTS_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__PIXEL_AGENTS_REACT_JSX__'),
    react: shimUrl('__PIXEL_AGENTS_REACT__')
  }
