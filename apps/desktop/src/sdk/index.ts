/**
 * @pixel-agents/plugin-sdk — THE plugin language. The vscode-module model: plugin
 ...
 *    object as `window.__PIXEL_AGENTS_PLUGIN_SDK__` and maps the import to it, so a
...
import { getLogs, getStatus } from '@/pixel-agents'
...
export type { RpcEvent, StatusResponse } from '@/types/pixel-agents'
