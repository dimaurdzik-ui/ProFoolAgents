...
const POPOUT_STORAGE_KEY = 'pixel-agents.desktop.composerPopout.zones.v1'
...
const LEGACY_ENABLED_KEY = 'pixel-agents.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'pixel-agents.desktop.composerPopout.position'
