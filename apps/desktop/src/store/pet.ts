...
export interface PetInfo {
  ...
  // the Pixel Agents "run" activity state uses the in-place running row).
 ...
 * PIXEL_AGENTS_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'pixel-agents.desktop.pet-roam.v1'
