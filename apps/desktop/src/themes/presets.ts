...
const PIXEL_BLUE = '#0053FD'
const PSYCHE_BLUE = '#1540B1'
const PSYCHE_WARM = '#FFE6CB'

const pixelTint = (pct: number) => `color-mix(in srgb, ${PIXEL_BLUE} ${pct}%, #FFFFFF)`
const pixelTintTransparent = (pct: number) => `color-mix(in srgb, ${PIXEL_BLUE} ${pct}%, transparent)`

/**
 * Pixel — canonical Pixel Agents desktop identity. The palette keeps the current
...
export const pixelTheme: DesktopTheme = {
  name: 'pixel',
  label: 'Pixel',
  description: 'Glass neutrals with Pixel blue accents',
  colors: {
    background: '#F8FAFF',
    foreground: '#17171A',
    card: '#FFFFFF',
    ...
    secondary: pixelTint(7),
    secondaryForeground: '#242432',
    accent: pixelTint(10),
    accentForeground: '#202030',
    border: pixelTintTransparent(22),
    input: pixelTintTransparent(30),
    ring: PIXEL_BLUE,
    midground: PIXEL_BLUE,
    composerRing: PIXEL_BLUE,
    destructive: '#C72E4D',
    destructiveForeground: '#FFFFFF',
    sidebarBackground: '#F3F7FF',
    sidebarBorder: pixelTintTransparent(18),
    userBubble: pixelTint(6),
    userBubbleBorder: pixelTintTransparent(24)
  },
  darkColors: {
    background: '#0D2F86',
...
export const DEFAULT_SKIN_NAME = 'pixel'
