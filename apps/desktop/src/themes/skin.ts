/**
 * Pixel Agents skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$PIXEL_AGENTS_HOME/skins/` (or a
 * built-in) resolved by `pixel_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Pixel Agents authors from a prompt lights up all three surfaces from one file.
 *
...
import type { PixelAgentsSkin, SkinColors } from '@pixel-agents/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: PixelAgentsSkin): DesktopTheme | null {
