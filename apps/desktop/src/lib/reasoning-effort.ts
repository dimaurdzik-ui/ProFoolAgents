...
/** Pixel Agents' reasoning levels, in ascending order — mirrors the backend's
 *  VALID_REASONING_EFFORTS (pixel_constants.py). `none` is not a level: it's
...
/** Pixel Agents' built-in level when neither the surface nor the profile config
