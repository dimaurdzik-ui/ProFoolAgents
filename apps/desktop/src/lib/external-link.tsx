...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|pixel-agents):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.pixelAgentsDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.pixelAgentsDesktop?.openExternal?.(href)
  }
}
