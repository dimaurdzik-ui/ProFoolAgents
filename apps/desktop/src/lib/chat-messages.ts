...
import { type BillingBlock, skillInvocationText } from '@pixel-agents/shared'
...
import type { MessageReaction, SessionMessage, UsageStats } from '@/types/pixel-agents'
...
export type GatewayEventPayload = {
  ...
  // with FailoverReason.billing (shape mirrors @pixel-agents/shared BillingBlock).
