...
import type { PixelAgentsReadDirEntry, PixelAgentsReadDirResult } from '@/global'
...
export type ProjectTreeEntry = PixelAgentsReadDirEntry
...
function ignoredBy(rules: GitignoreRule[], entry: PixelAgentsReadDirEntry) {
...
async function filterIgnored(entries: PixelAgentsReadDirEntry[], rootPath: string, dirPath: string) {
...
export async function readProjectDir(dirPath: string, rootPath = dirPath): Promise<PixelAgentsReadDirResult> {
