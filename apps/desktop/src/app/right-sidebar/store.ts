...
const TAKEOVER_KEY = 'pixel-agents.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Pixel Agents can't clear via the API — the user
 *  sees exactly what runs instead of Pixel Agents silently deleting their creds. */
