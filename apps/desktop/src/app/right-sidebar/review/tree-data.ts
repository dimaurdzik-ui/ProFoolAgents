import type { PixelAgentsReviewFile } from '@/global'
...
export function buildReviewFlatList(files: PixelAgentsReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: PixelAgentsReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
