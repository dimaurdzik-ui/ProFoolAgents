...
import { type DroppedFile, extractDroppedFiles, PIXEL_AGENTS_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, PIXEL_AGENTS_PATHS_MIME) ? 'files' : null
