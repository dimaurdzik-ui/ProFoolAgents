...
// hairline `--stroke-pixel` paired with the soft `--shadow-pixel` float.
...
export const HUD_SURFACE =
  'rounded-xl border border-(--stroke-pixel) bg-(--ui-chat-bubble-background) shadow-pixel [-webkit-app-region:no-drag]'
