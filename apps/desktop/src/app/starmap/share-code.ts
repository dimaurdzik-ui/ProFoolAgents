...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/pixel-agents'
...
const VERSION = 3
const PREFIX = 'HML' // "Pixel Agents Memory Loadout" — namespaces our codes like WoW's leading bytes.
