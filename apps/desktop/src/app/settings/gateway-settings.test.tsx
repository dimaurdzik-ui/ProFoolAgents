...
beforeEach(() => {
  profiles.set([
    ...
    },
    {
      ...
      model: null,
      name: 'work',
      path: '/tmp/pixel-agents/profiles/work',
      provider: null,
      skill_count: 0
    }
  ])
...
describe('GatewaySettings', () => {
  it('labels local mode as default inheritance for a named profile', async () => {
    ...
    expect(
      screen.getByText('Start a private Pixel Agents backend on localhost. This is the default and works offline.')
    ).toBeTruthy()
    ...
    expect(
      screen.queryByText('Start a private Pixel Agents backend on localhost. This is the default and works offline.')
    ).toBeNull()
  })
})
