...
import type { ConfigFieldSchema, PixelAgentsConfigRecord, ToolsetInfo } from '@/types/pixel-agents'
...
export function getNested(obj: PixelAgentsConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function sectionFieldEntries(
  ...
  config: PixelAgentsConfigRecord
...
export function setNested(obj: PixelAgentsConfigRecord, path: string, value: unknown): PixelAgentsConfigRecord {
...
function personalityOptions(config: PixelAgentsConfigRecord): string[] {
...
function commandProviderNames(config: PixelAgentsConfigRecord, section: 'tts' | 'stt'): string[] {
