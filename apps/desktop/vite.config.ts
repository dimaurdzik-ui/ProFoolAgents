...
const emojibaseAssets = () => ({
  name: 'pixel-agents:emojibase-assets',
...
export default defineConfig(({ command }) => ({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\pixel-agents\pixel-agents\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@pixel-agents/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@pixel-agents/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@pixel-agents/shared': path.resolve(__dirname, '../shared/src'),
