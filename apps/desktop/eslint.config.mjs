...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @pixel-agents/plugin-sdk (+ react), never `@/…`
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@pixel-agents/shared'],
              message: 'Plugins import only @pixel-agents/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
