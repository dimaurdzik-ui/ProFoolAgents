 ...
 * Apps) login to a gated Pixel Agents gateway: system-browser + loopback redirect +
 ...
 * upstream IDP (Pixel Portal) issues a per-gateway-instance client_id and only
...
// pixel_cli/web_server.py status handler.
