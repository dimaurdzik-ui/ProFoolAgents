 ...
 *
 * A public install can end up with `origin=git@github.com:PixelResearch/pixel-agents.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/PixelResearch/pixel-agents.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/pixelagents/pixel-agents'
