...
def _profile_user_agent() -> str:
    """Return a ``pixel-agents-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from pixel_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"pixel-agents-cli/{_ver}"
    except Exception:
        return "pixel-agents-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # pixel-agents-cli UA so the catalog endpoint is reachable.
