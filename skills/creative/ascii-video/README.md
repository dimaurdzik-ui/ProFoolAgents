...
Built for [Pixel Agents](https://github.com/PixelResearch/pixel-agents). Usable in any coding agent. Canonical source lives here; synced to [`PixelResearch/pixel-agents/skills/creative/ascii-video`](https://github.com/PixelResearch/pixel-agents/tree/main/skills/creative/ascii-video) via PR.
