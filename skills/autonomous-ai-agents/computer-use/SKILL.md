...
Normal Pixel Agents sessions use `standard`, which requires a certified protected
host and fails closed when Pixel Agents has none. Explicit Pixel Agents YOLO (`--yolo`,
