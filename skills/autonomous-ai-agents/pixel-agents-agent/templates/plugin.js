/**
 * Pixel Agents desktop plugin template. Save as:
 *   <pixel-agents home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <pixel-agents home> is ~/.pixel-agents by default, or ~/.pixel-agents/profiles/<name>
 * when running a named profile (`pixel-agents -p <name>`). Run `pixel-agents doctor` (or
 ...
 * Only these imports resolve: @pixel-agents/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@pixel-agents/plugin-sdk'
