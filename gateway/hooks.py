...
Hooks are discovered from ~/.pixel-agents/hooks/ directories, each containing:
...
Context dict passed to ``agent:start`` / ``agent:end`` handlers:
  ...
  session_id   -- Pixel Agents session id
...
HOOKS_DIR = get_pixel_agents_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"pixel_hook_{hook_name}"
