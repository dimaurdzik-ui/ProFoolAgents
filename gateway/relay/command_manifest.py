...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Pixel Agents session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Pixel Agents session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Pixel Agents agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Pixel Agents to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Pixel Agents gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Pixel Agents session in it",
