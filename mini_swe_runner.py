#!/usr/bin/env python3
"""
SWE Runner with Pixel Agents Trajectory Format

A runner that uses Pixel-Agents's built-in execution environments
(local, docker, modal) and outputs trajectories in the Pixel-Agents format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Pixel-Agents's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Pixel Agents format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Pixel-Agents format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Pixel-Agents's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Pixel Agents Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Pixel-Agents's built-in execution environments
    and outputs trajectories in Pixel-Agents format.
    """
    ...
    def _convert_to_pixel_format(
        ...
        """
        Convert internal message format to Pixel Agents trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Pixel Agents trajectory format
        trajectory = self._convert_to_pixel_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Pixel Agents trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Pixel Agents Trajectory Format")
    print("=" * 60)
