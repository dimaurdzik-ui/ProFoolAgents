---
sidebar_position: 8
title: "Use Voice Mode with Pixel Agents"
description: "A practical guide to setting up and using Pixel Agents voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Pixel Agents
...
:::tip
[Pixel Portal](/integrations/pixel-portal) bundles both the LLM and TTS through one OAuth — voice mode works end-to-end with no extra credentials.
:::
...
- you want Pixel Agents sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Pixel Agents.
...
## Step 1: make sure normal Pixel Agents works first
...
Pixel Agents supports both local and cloud speech stacks.
...
4. Pixel Agents transcribes and responds
...
- asking Pixel Agents to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Pixel Agents loop.

## Tuning CLI behavior

### Silence threshold

If Pixel Agents starts/stops too aggressively, tune:
...
Pixel Agents stays a normal chat bot, but can speak replies.
...
- you want Pixel Agents to function like a portable research or ops assistant
...
Pixel Agents joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Pixel Agents detects speech boundaries
- transcripts are posted in the associated text channel
- Pixel Agents responds in text and audio
...
1. get text Pixel Agents working
2. run `pixel-agents setup tts` to enable voice support
