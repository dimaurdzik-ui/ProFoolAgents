...
| [`pixel-agents`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-pixel-agents) | Use, configure, theme, extend, and orchestrate Pixel Agents. | `autonomous-ai-agents/pixel-agents` |
...
| [`pixel-agents-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-pixel-agents-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development/pixel-agents-skill-authoring` |
| [`inspecting-pixel-agents-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-pixel-agents-desktop-dom) | Read the live Pixel Agents desktop DOM/CSS over CDP. | `software-development/inspecting-pixel-agents-desktop-dom` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Write a markdown plan to .pixel-agents/plans/; no execution. | `software-development/plan` |
