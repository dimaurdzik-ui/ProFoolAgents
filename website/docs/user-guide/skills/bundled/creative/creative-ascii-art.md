...
```bash
python3 -m pyfiglet "PIXEL_AGENTS" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=PIXEL_AGENTS&font=Slant" | boxes -d stone
```
