...
| Related skills | [`claude-code`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-claude-code), [`pixel-agents`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-pixel-agents) |
...
Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Pixel Agents terminal. Codex is OpenAI's autonomous coding agent CLI.
...
For Pixel Agents itself, `model.provider: openai-codex` uses Pixel Agents-managed Codex
OAuth from `~/.pixel-agents/auth.json` after `pixel-agents auth add openai-codex`. For the
...
## Pixel Agents Gateway Caveat

When invoking the Codex CLI from a Pixel Agents gateway/service context (for example,
