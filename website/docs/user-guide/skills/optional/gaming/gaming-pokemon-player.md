...
| | |
|---|---|
| Source | Optional — install with `pixel-agents skills install official/gaming/pokemon-player` |
...
The repo is PixelResearch/pokemon-agent on GitHub. Clone it, then
