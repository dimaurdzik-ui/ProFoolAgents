...
| | |
|---|---|
| Source | Optional — install with `pixel-agents skills install official/health/neuroskill-bci` |
...
Connect Pixel Agents to a running [NeuroSkill](https://neuroskill.com/) instance to read
