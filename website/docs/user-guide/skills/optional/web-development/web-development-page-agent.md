...
| | |
|---|---|
| Source | Optional — install with `pixel-agents skills install official/web-development/page-agent` |
...
- User wants **Pixel Agents itself to drive a browser** → use Pixel Agents' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
