...
| | |
|---|---|
| Source | Optional — install with `pixel-agents skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Pixel Agents (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $PIXEL_AGENTS_OSINT_CACHE/icij/ (default: ~/.cache/pixel-agents-osint/icij/).
...
# Set PIXEL_AGENTS_OSINT_UA=your-app/1.0 (your@email) to identify yourself
