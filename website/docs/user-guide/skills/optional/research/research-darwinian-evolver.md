...
| | |
|---|---|
| Source | Optional — install with `pixel-agents skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Pixel Agents |
| License | MIT |
...
import upstream classes into Pixel Agents itself.
...
```bash
mkdir -p ~/.pixel-agents/cache/darwinian-evolver && cd ~/.pixel-agents/cache/darwinian-evolver
...
```bash
cd ~/.pixel-agents/cache/darwinian-evolver/darwinian_evolver \
...
Open `~/.pixel-agents/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
SKILL_DIR=~/.pixel-agents/skills/research/darwinian-evolver
DE_DIR=~/.pixel-agents/cache/darwinian-evolver/darwinian_evolver
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Pixel Agents core.
   Custom driver scripts under `~/.pixel-agents/skills/...` are user-side and fine.
