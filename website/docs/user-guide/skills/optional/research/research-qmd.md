...
| | |
|---|---|
| Source | Optional — install with `pixel-agents skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`pixel-agents`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-pixel-agents), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
Pixel Agents via the native MCP client. This is the preferred
...
Then configure Pixel Agents to connect via HTTP:
