...
| | |
|---|---|
| Source | Optional — install with `pixel-agents skills install official/research/gitnexus-explorer` |
...
| Related skills | [`pixel-agents`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-pixel-agents), [`codebase-inspection`](/docs/user-guide/skills/bundled/github/github-codebase-inspection) |
