---
title: "Honcho — Configure and troubleshoot Honcho memory for Pixel Agents"
...
Configure and troubleshoot Honcho memory for Pixel Agents.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `pixel-agents skills install official/autonomous-ai-agents/honcho` |
