...
| | |
|---|---|
| Source | Optional — install with `pixel-agents skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing pixel-agents tool access (web_search, file ops). Stateless. |
