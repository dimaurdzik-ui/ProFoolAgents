...
| | |
|---|---|
| Source | Optional — install with `pixel-agents skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Pixel Agents |
| License | MIT |
...
```
SCRIPT=~/.pixel-agents/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.pixel-agents/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
