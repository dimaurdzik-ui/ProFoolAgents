...
| | |
|---|---|
| Source | Optional — install with `pixel-agents skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.pixel-agents/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.pixel-agents/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Pixel Agents installs package this)
