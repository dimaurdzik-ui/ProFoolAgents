...
| | |
|---|---|
| Source | Optional — install with `pixel-agents skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Pixel Agents |
| License | MIT |
...
The script reads `${PIXEL_AGENTS_HOME:-~/.pixel-agents}/.env` for two optional defaults:
...
Helper script: `~/.pixel-agents/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.pixel-agents/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${PIXEL_AGENTS_HOME:-~/.pixel-agents}/.env`.
...
```bash
python3 ~/.pixel-agents/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.pixel-agents/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
