...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to Pixel Agents — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to Pixel Agents! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- Building a custom/local tool without modifying Pixel Agents core? Start with [Build a Pixel Agents Plugin](../developer-guide/plugins/index.md)
- Building a new built-in core tool for Pixel Agents itself? Start with [Adding Tools](./adding-tools.md)
...
You can also run a fully isolated Pixel Agents instance (throwaway PIXEL_AGENTS_HOME, separate Electron
userData, distinct Electron app name to avoid the single-instance lock):

```bash
scripts/dev-sandbox.sh python -m pixel_cli.main
scripts/dev-sandbox.sh --persistent python -m pixel_cli.main desktop  # state survives restarts, but lives in the worktree :)
```
...
echo 'OPENROUTER_API_KEY=sk-or-v1-your-key' >> ~/.pixel-agents/.env
```
...
- **Profile-safe paths**: Never hardcode `~/.pixel-agents` — use `get_pixel_agents_home()` from `pixel_constants` for code paths and `display_pixel_agents_home()` for user-facing messages. See [AGENTS.md](https://github.com/PixelResearch/pixel-agents/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
- **Discord**: [discord.gg/PixelResearch](https://discord.gg/PixelResearch)
- **GitHub Discussions**: For design proposals and architecture discussions
- **Skills Hub**: Upload specialized skills and share with the community

## License

By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/PixelResearch/pixel-agents/blob/main/LICENSE).
