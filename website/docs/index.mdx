...
slug: /
sidebar_position: 0
title: "Pixel Agents Documentation"
description: "The self-improving AI agent built by Pixel Agents. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [Pixel Agents](https://pixelagents.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
After installing, run `pixel-agents setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Pixel Portal](/integrations/pixel-portal).
:::
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Pixel Agents safely  |
| 🧭 **[Use MCP with Pixel Agents](/guides/use-mcp-with-pixel-agents)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Pixel Agents](/guides/use-voice-mode-with-pixel-agents)** | Hands-on setup and usage patterns for Pixel Agents voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Pixel Agents' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Pixel Agents                              |
...
- **Built by model trainers** — Created by [Pixel Agents](https://pixelagents.com), the lab behind Pixel Agents, Nomos, and Psyche. Works with [Pixel Portal](https://portal.pixelagents.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Full web control** — Search, extract, browse, vision, image generation, TTS — one subscription via [Pixel Portal](/integrations/pixel-portal) bundles all of them
- **MCP support** — Connect to any MCP server for extended tool capabilities
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Pixel Agents](https://pixelagents.com) — the lab behind Pixel Agents, Nomos, and Psyche models
