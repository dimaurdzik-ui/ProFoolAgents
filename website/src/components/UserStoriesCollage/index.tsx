  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Pixel Agents community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Pixel Agents &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Pixel Agents?{' '}
        <a
          href="https://github.com/PixelResearch/pixel-agents/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/PixelResearch" target="_blank" rel="noopener noreferrer">
