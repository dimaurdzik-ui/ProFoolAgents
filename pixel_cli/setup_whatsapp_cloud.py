...
Entry point: ``pixel-agents whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``pixel_cli/main.py``).
...
Pixel Agents gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Pixel Agents to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Pixel Agents needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Pixel Agents gateway in another terminal:")
    print("         pixel-agents gateway")
    print()
    ...
    print()
    print("  Docs: https://api.pixelagents.com/docs/user-guide/")
