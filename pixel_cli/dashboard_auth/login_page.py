...
Visual styling mirrors the Pixel Agents design system (the
``@pixel-agents/ui`` package the React dashboard uses): the same
...
``tests/pixel_cli/test_dashboard_auth_401_reauth.py``.
"""
...
<title>Sign in — Pixel Agents</title>
<style>
  /* Brand fonts shipped by @pixel-agents/ui — same files the SPA loads. */
  @font-face {{
...
<body>
<main>
  <div class="brand">Pixel<span class="dot"></span>Research</div>
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the Pixel Agents dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — Pixel Agents</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
...
<p>Install <code>plugins/dashboard-auth-pixel</code> (default) or another
