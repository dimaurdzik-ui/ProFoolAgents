...
Invoked by ``pixel-agents kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Pixel Agents board.
...
def _profile_author() -> str:
    """Mirror of ``pixel_cli.kanban._profile_author``."""
    return (
