"""
Pixel Agents CLI - Unified command-line interface for Pixel Agents.

Provides subcommands for:
- pixel-agents chat          - Interactive chat (same as ./pixel-agents)
- pixel-agents gateway       - Run gateway in foreground
- pixel-agents gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `pixel-agents setup` on a fresh Pi.
    ...
    pixel_cli/stdio.py::configure_windows_stdio() runs later from the entry
