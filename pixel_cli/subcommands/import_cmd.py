"""``pixel-agents import`` subcommand parser.
...
def build_import_cmd_parser(subparsers, *, cmd_import: Callable) -> None:
    ...
    import_parser = subparsers.add_parser(
        "import",
        help="Restore a Pixel Agents backup from a zip file",
        description="Extract a previously created Pixel Agents backup into your "
        "Pixel Agents home directory, restoring configuration, skills, "
        "sessions, and data",
    )
