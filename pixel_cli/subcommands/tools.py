"""``pixel-agents tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'pixel-agents tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # pixel-agents tools list [--platform cli]
    ...
    # pixel-agents tools disable <name...> [--platform cli]
    ...
    # pixel-agents tools enable <name...> [--platform cli]
    ...
    # pixel-agents tools post-setup <key>
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `pixel-agents tools` runs after you pick a provider that\n"
