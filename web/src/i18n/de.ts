...
export const de: Translations = {
  ...
  status: {
    ...
    stopped: "Gestoppt",
    updatePixelAgents: "Pixel Agents aktualisieren",
    updatingPixelAgents: "Pixel Agents wird aktualisiert…",
  ...
  pluginsPage: {
    ...
    headline:
      "Pixel Agents-Plugins entdecken, installieren, aktivieren und aktualisieren (entspricht `pixel-agents plugins`).",
    ...
    removeConfirm: "Dieses Plugin aus ~/.pixel-agents/plugins/ entfernen?",
    removeHint: "Nur vom Benutzer installierte Plugins unter ~/.pixel-agents/plugins können entfernt werden.",
  ...
  skills: {
    ...
    filters: "Filter",
    noSkills: "Keine Skills gefunden. Skills werden aus ~/.pixel-agents/skills/ geladen",
  ...
  env: {
    ...
    customHint: "Beliebige Umgebungsvariablen in deiner .env, die Pixel Agents nicht erkennt. Verwende sie, um Umgebungsvariablen für Skills, MCP-Server oder eigene Tools einzuschleusen.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Sammelbare Pixel Agents-Abzeichen, verdient durch echten Sitzungsverlauf. Bekannte, noch nicht abgeschlossene Achievements werden als Entdeckt angezeigt; geheime Achievements bleiben verborgen, bis das erste passende Verhalten auftritt.",
      scan_subtitle:
        "Pixel Agents-Sitzungsverlauf wird gescannt. Der erste Scan kann bei umfangreichem Verlauf 5–10 Sekunden dauern.",
    },
    actions: {
      rescan: "Neu scannen",
    },
    stats: {
      ...
      latest: "Neueste",
      latest_hint_empty: "nutze Pixel Agents mehr",
      none_yet: "Noch keine",
    },
    state: {
      unlocked: "Freigeschaltet",
    ...
    guide: {
      ...
      secret_body:
        "Geheimnisse verbergen ihren genauen Auslöser. Sobald Pixel Agents ein verwandtes Signal erkennt, wird die Karte zu Entdeckt und zeigt ihre Anforderung an.",
      scan_status_header: "Scan-Status",
      scan_status_body:
        "Pixel Agents scannt den lokalen Verlauf einmalig, danach erscheinen die Karten automatisch. Es ist nichts hängengeblieben, wenn dies ein paar Sekunden dauert.",
