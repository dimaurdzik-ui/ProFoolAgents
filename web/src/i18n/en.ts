...
export const en: Translations = {
  ...
  status: {
    ...
    updatePixelAgentsConfirmMessage:
      "This runs pixel-agents update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updatePixelAgentsConfirmNow: "Update now",
    updatePixelAgentsConfirmTitle: "Update Pixel Agents?",
    updatingPixelAgents: "Updating Pixel Agents…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Pixel Agents plugins (`pixel-agents plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.pixel-agents/plugins/?",
    removeHint: "Only user-installed plugins under ~/.pixel-agents/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.pixel-agents/skills/",
  ...
  config: {
    configPath: "~/.pixel-agents/config.yaml",
    filters: "Filters",
    sections: "Sections",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Pixel Agents doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "Pixel Agents Achievements",
      subtitle:
        "Collectible Pixel Agents badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Pixel Agents session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Pixel Agents more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Pixel Agents sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Pixel Agents is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Pixel Agents ☤",
    },
  },
