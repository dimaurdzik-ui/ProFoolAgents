 ...
 *
 * Values mirror pixel_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Pixel Agents default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Pixel Agents' default when unset). */
