...
const STORAGE_KEY = "pixel-agents-dashboard-theme";
...
const FONT_STORAGE_KEY = "pixel-agents-dashboard-font";
...
const THEME_NAME_ALIASES: Record<string, string> = {
  // Renamed during the LENS_5I port + Pixel-blue rebrand.
  "lens-5i": "pixel-blue",
};
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `pixel_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "pixel-agents-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-pixel-agents-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-pixel-agents-theme-font", "true");
...
function applyTheme(theme: DashboardTheme) {
  ...
  // (e.g. Pixel Blue) doesn't leave its values behind when the user
