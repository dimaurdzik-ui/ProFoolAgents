 ...
 * `window.__PIXEL_AGENTS_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Pixel Agents brand in the top bar
 ...
 *  `window.__PIXEL_AGENTS_PLUGINS__.registerSlot(...)`.
 *
