 ...
 *
 * Plugins call window.__PIXEL_AGENTS_PLUGINS__.register(name, Component)
...
import { Card, CardHeader, CardTitle, CardContent } from "@pixel-agents/ui/ui/components/card";
import { Input } from "@pixel-agents/ui/ui/components/input";
import { Label } from "@pixel-agents/ui/ui/components/label";
import { Separator } from "@pixel-agents/ui/ui/components/separator";
import { Tabs, TabsList, TabsTrigger } from "@pixel-agents/ui/ui/components/tabs";
 ...
 * Exposed at runtime as ``window.__PIXEL_AGENTS_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__PIXEL_AGENTS_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__PIXEL_AGENTS_PLUGIN_SDK__ = {
    ...
    // window.__PIXEL_AGENTS_SESSION_TOKEN__ directly.
    authedFetch,
    ...
    // UI components — Pixel DS where available, shadcn/ui primitives elsewhere.
    components: {
      Card,
      CardHeader,
      CardTitle,
