...
_SESSION_CWD: ContextVar = ContextVar("PIXEL_AGENTS_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    # configured path is otherwise honored verbatim — including the Pixel Agents
    # source tree itself, which is a legitimate workspace when the user is
    # developing Pixel Agents (per-surface policy for fallback-picked directories
