...
_OFFICIAL_DOCS_PRICING: Dict[tuple[str, str], PricingEntry] = {
    ...
    # Fireworks AI — serverless pricing for the models pixel-agents typically routes
...
def resolve_billing_route(
    ...
    if provider_name == "pixel" or base_url_host_matches(base_url or "", "inference-api.pixelagents.com"):
        return BillingRoute(provider="pixel", model=model, base_url=base_url or _PIXEL_DEFAULT_BASE_URL, billing_mode="official_models_api")
