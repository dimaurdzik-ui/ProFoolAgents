"""Core NeMo Relay adapter for Pixel Agents tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Pixel Agents tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchropixel Pixel Agents Relay tool execution cannot run on an active event-loop thread"
    )
