...
anthropic, pixel, copilot), a long-context compression restart, a length-
...
class TurnRetryState:
    ...
    pixel_auth_retry_attempted: bool = False
    pixel_paid_entitlement_refresh_attempted: bool = False
