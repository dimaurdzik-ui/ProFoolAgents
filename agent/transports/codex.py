...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # through Pixel Agents's agent loop.
        #
        ...
        # that would silently route around Pixel Agents's web-provider config and
        ...
        # native search engine for xAI sessions instead of Pixel Agents's
        # configured web provider (Tavily/etc.), and those results bypass
        # Pixel Agents's tool-trace / citation plumbing (they arrive baked into the
