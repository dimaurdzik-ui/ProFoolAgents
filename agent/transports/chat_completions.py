...
providers (OpenRouter, Pixel, NVIDIA, Qwen, Ollama, DeepSeek, xAI, Kimi, etc.).
...
def _build_gemini_thinking_config(model: str, reasoning_config: dict | None) -> dict | None:
    """Translate Pixel Agents/OpenRouter-style reasoning config to Gemini thinkingConfig."""
    ...
    # Gemini 2.5 accepts thinkingBudget; don't guess a budget from Pixel Agents'
    ...
    # is stricter (low/high). Clamp Pixel Agents' wider effort set to what each
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def convert_messages(
        ...
        - Pixel Agents-internal scaffolding markers — any top-level message key
        ...
        for msg_idx, msg in enumerate(messages):
            ...
            # Drop all Pixel Agents-internal scaffolding markers (``_``-prefixed).
    ...
    def build_kwargs(
        ...
        **params,
        ...
        params (all optional):
            ...
            # Claude on OpenRouter/Pixel max output
        ...
        if tools:
            ...
            # tool parameters here keeps aggregator routes (Pixel, OpenRouter,
    ...
    def _build_kwargs_from_profile(self, profile, model, sanitized, tools, params):
        ...
        if extra_body:
            ...
            # This happens when a profile that emits extra_body (e.g. the Pixel
    ...
    def normalize_response(self, response: Any, **kwargs) -> NormalizedResponse:
        ...
        # Bedrock (e.g. Pixel Portal) surface a Claude refusal this way — or via
