...
decomposition campaign (``~/.pixel-agents/plans/god-file-decomposition.md``, Phase 1
...
to the caller. The function is synchropixel with a single return — mirroring the
...
def finalize_turn(
    ...
    *,
    ...
    if iteration_limit_fallback:
        ...
        _kanban_task = os.environ.get("PIXEL_AGENTS_KANBAN_TASK")
        if _kanban_task:
            try:
    ...
    result = {
        ...
        # billing audits by callers like `pixel-agents -z --usage-file`.
        "service_tier": (
