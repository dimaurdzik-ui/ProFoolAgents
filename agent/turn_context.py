...
def build_turn_context(
    ...
    *,
    ...
    # Tag log records on this thread with the session ID for ``pixel-agents logs``.
    ...
    if agent.compression_enabled and _should_run_preflight_estimate(
        ...
        # Pixel Agents only initiates compaction in "pixel-agents" mode (#36801).
        _codex_native_auto = (
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping Pixel Agents preflight compression for codex app-server "
                "(mode=%s); Pixel Agents will not start thread compaction here.",
