"""Vertex AI (Google Cloud) adapter for Pixel Agents.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Pixel Agents to use Gemini models via Google Cloud with
...
# who installed plain `pixel-agents` and only later selected a Gemini model.
try:
