...
#
# See: https://github.com/PixelResearch/pixel-agents/issues/27344
...
# case: a stream dies mid-response and Pixel Agents persists a content-less
...
def _classify_by_status(
    ...
    *,
    ...
    if status_code == 401:
        ...
        # provider-specific refresh (Codex, Anthropic, Pixel) run before
    ...
    if status_code == 404:
        # Pixel API currently surfaces HA/NAS credit depletion as a paid model
