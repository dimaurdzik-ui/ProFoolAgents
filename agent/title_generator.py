...
Runs asynchropixelly after the first response is delivered so it never
...
def _auto_title_enabled() -> bool:
    ...
    try:
        ...
        # from agent code paths where a module-level pixel_cli import risks
...
def auto_title_session(
    ...
    post-``pixel-agents update`` stale-module window, where this function's lazy
    ...
    try:
        ...
        logger.warning(
            ...
            "restart the running Pixel Agents process): %s",
            e,
        )
