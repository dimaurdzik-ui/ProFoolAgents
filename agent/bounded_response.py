...
When a provider returns a non-OK status on a *streaming* request, Pixel Agents reads
...
streams"), generalized to cover Pixel Agents's three streaming error-body sites
