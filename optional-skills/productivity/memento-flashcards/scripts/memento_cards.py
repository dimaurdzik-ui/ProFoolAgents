...
Data file: $PIXEL_AGENTS_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_PIXEL_AGENTS_HOME = Path(os.environ.get("PIXEL_AGENTS_HOME", Path.home() / ".pixel-agents"))
DATA_DIR = _PIXEL_AGENTS_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
