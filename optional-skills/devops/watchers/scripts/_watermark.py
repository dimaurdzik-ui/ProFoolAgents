...
def _state_dir() -> Path:
    ...
    # Default: $PIXEL_AGENTS_HOME/watcher-state/, falling back to ~/.pixel-agents/watcher-state/.
    pixel_home = os.environ.get("PIXEL_AGENTS_HOME") or str(Path.home() / ".pixel-agents")
    return Path(pixel_home) / "watcher-state"
