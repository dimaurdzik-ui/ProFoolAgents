...
DEFAULT_UA = (
    "pixel-agents-osint-investigation/0.2 "
    "(+https://github.com/PixelResearch/pixel-agents; "
    "set PIXEL_AGENTS_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("PIXEL_AGENTS_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
