...
``_check_spotify_available()`` — when the user has not run ``pixel-agents auth
spotify``, the tools remain registered (so they appear in ``pixel-agents
...
The Spotify auth flow (``pixel-agents auth spotify``), CLI plumbing, and docs
