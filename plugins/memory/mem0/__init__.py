...
Configuration
-------------
Secret (lives in $PIXEL_AGENTS_HOME/.env or the environment):
...
Behavioral settings (live in $PIXEL_AGENTS_HOME/mem0.json, set via `pixel-agents memory
setup`):
  ...
  agent_id           — Agent identifier (default: pixel-agents)
...
_DEFAULT_USER_ID = "pixel-agents-user"
...
def _load_config() -> dict:
    """Load config from env vars, with $PIXEL_AGENTS_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "pixel-agents"),
        "oss": {},
    }
    ...
    config_path = get_pixel_agents_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, pixel_home):
        """Write config to $PIXEL_AGENTS_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $PIXEL_AGENTS_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "pixel-agents")
    ...
    def handle_tool_call(self, tool_name: str, args: dict, **kwargs) -> str:
        ...
        if tool_name == "mem0_search":
            ...
            try:
                ...
                # Cloud add is async (server-side extraction); OSS and self-hosted store synchropixelly.
