...
Working directory: $PIXEL_AGENTS_HOME/byterover/ (profile-scoped context tree)
"""
...
def _get_brv_cwd() -> Path:
    ...
    return get_pixel_agents_home() / "byterover"
...
class ByteRoverMemoryProvider(MemoryProvider):
    ...
    def prefetch(self, query: str, *, session_id: str = "") -> str:
        """Run brv query synchropixelly before the agent's first LLM call.
    ...
    def queue_prefetch(self, query: str, *, session_id: str = "") -> None:
        """No-op: prefetch() now runs synchropixelly at turn start."""
        pass
