...
existing Pixel Portal access token (the same token it already uses to call the
...
class NasCronClient:
    ...
    Uses the agent's refresh-aware Pixel access token for auth. No scheduler
    ...
    def _access_token(self) -> str:
        """The agent's existing Pixel Portal access token (refresh-aware)."""
