# Pixel Agents Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.pixel-agents/plugins/pixel-agents-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.pixel-agents/plugins/pixel-agents-achievements/scan_checkpoint.json`.
