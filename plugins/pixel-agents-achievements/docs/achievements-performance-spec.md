# Pixel Agents Achievements Performance Spec (Post-Hackathon)

Status: Draft (no code changes yet)
Owner: pixel-agents-achievements plugin
...
### `GET /api/plugins/pixel-agents-achievements/achievements`
...
### `POST /api/plugins/pixel-agents-achievements/rescan` (optional)
Manual refresh trigger.
Prefer async trigger + immediate status response.

### `GET /api/plugins/pixel-agents-achievements/scan-status` (optional new)
Reports scan state for UX/ops.

### Removed
- `GET /api/plugins/pixel-agents-achievements/overview`
...
- Persist plugin data under:
  - `~/.pixel-agents/plugins/pixel-agents-achievements/scan_snapshot.json`

### Phase 2
- Incremental scan checkpoints with per-session fingerprints.
- Persist checkpoint data under:
  - `~/.pixel-agents/plugins/pixel-agents-achievements/scan_checkpoint.json`
...
- `~/.pixel-agents/plugins/pixel-agents-achievements/`
