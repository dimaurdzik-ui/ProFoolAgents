# Pixel Agents Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.pixel-agents/plugins/pixel-agents-achievements/state.json` (existing unlock state)
  - `~/.pixel-agents/plugins/pixel-agents-achievements/scan_snapshot.json` (new)
  - `~/.pixel-agents/plugins/pixel-agents-achievements/scan_checkpoint.json` (new)
