...
required — uses aiohttp which is already a Pixel Agents dependency.
...
def interactive_setup() -> None:
    ...
    ``pixel_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Pixel Agents delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # pixel_cli/setup.py::_setup_mattermost function.
