...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Pixel Agents gateway adapter.

    Each inbound phone number gets its own Pixel Agents session (multi-tenant).
...
# static dict in pixel_cli/gateway.py, and the _send_sms dispatch in
