...
Config: ~/.pixel-agents/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.pixel-agents/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_pixel_agents_home()`` helper (PIXEL_AGENTS_HOME-aware and
...
RULES_FILE = get_pixel_agents_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_pixel_agents_home() / "feishu_comment_pairing.json"
