...
// `message.content.text` before Pixel Agents can see it. We rewrite the two inbound
...
const MARKER = "Pixel Agents patch: Preserve mixed text + attachment iMessage payloads";
