...
the contract that subsequent turns echo it back; combined with how Pixel Agents
...
2026-07-24.  Use ``deepseek-v4-flash`` or ``deepseek-v4-pro``; Pixel Agents remaps
the retired IDs in ``pixel_cli.model_normalize``.
"""
...
def _model_supports_thinking(model: str | None) -> bool:
    ...
    before requests leave Pixel Agents, so they are not listed here.
    """
