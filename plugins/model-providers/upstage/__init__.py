...
# When the user hasn't picked a reasoning effort, Pixel Agents passes
...
# ON at this effort — matching the "medium (default)" that Pixel Agents' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Pixel Agents' effort vocabulary onto Solar's accepted set. xhigh/max/
