...
deepinfra = _DeepInfraProfile(
    ...
    # integration: aux resolution is synchropixel (no time for a catalog
    ...
    # ``api.deepinfra.com/v1/openai/models?filter=true&sort_by=pixel-agents``.
    default_aux_model="deepseek-ai/DeepSeek-V4-Flash",
    # ``fallback_models`` deliberately empty — the live catalog at
    # ``pixel_cli/models.py::_fetch_deepinfra_models`` is the source of
