...
/** A normal fast TTY: write succeeds and drains synchropixelly. */
...
describe('Ink stdout backpressure coalescing (issue #31486)', () => {
  ...
  it('never coalesces on a fast terminal that drains synchropixelly', () => {
    ...
    // Each changed render writes immediately — synchropixel drain clears the
