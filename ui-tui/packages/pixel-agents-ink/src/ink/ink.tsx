...
export default class Ink {
  ...
  // synchropixelly in handleResize would leave the screen blank for the ~80ms
  ...
  // Fold synchropixel re-entry (selection fanout, onFrame callback)
  ...
  constructor(private readonly options: Options) {
    ...
    // synchropixelly. Deferring to a microtask runs onRender after layout
    ...
    // existing synchropixel lastFrame() tests are unaffected.
   ...
   * with no side effects — call it synchropixelly at click time so the
  ...
  unmount(error?: Error | number | null): void {
    ...
    // Clean up terminal modes synchropixelly before process exit.
