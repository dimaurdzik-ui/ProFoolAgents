import { Box, type ScrollBoxHandle, stringWidth, Text } from '@pixel-agents/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (PIXEL_AGENTS_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (PIXEL_AGENTS_DEV_CREDITS), lowest priority,
