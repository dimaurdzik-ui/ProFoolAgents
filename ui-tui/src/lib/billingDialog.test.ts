import type { BillingBlock } from '@pixel-agents/shared/billing'
...
describe('billingDialogCopy', () => {
  it('routes Pixel to the /topup flow', () => {
    const copy = billingDialogCopy(makeBlock({ is_pixel: true, provider: 'pixel', provider_label: 'Pixel Portal' }))
    expect(copy.title).toContain('Pixel')
