import type { BillingBlock, UsageModelData } from '@pixel-agents/shared/billing'
import type { PixelAgentsSkin } from '@pixel-agents/shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@pixel-agents/shared`).
 *  Includes the paired light_colors/dark_colors overlays from #20379. */
export type GatewaySkin = PixelAgentsSkin
...
// Wire shapes now live in @pixel-agents/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingBlock,
  BillingCardInfo,
  ...
  UsageBarData,
  UsageModelData
} from '@pixel-agents/shared/billing'
