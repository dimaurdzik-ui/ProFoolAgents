...
import type { ScrollBoxHandle } from '@pixel-agents/ink'
import { evictInkCaches } from '@pixel-agents/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.PIXEL_AGENTS_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
