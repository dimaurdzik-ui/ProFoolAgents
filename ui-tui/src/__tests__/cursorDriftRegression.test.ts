 ...
 *
 * Symptom: in `pixel-agents --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@pixel-agents/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using pixel-agents --tui and as i type multiline my caret at the end will often ' +
