...
// PIXEL_AGENTS_TUI_VISUAL_DIR overrides it for CI or side-by-side runs.
import { tmpdir } from 'os'
import { join } from 'path'

export function visualOutDir() {
  return process.env.PIXEL_AGENTS_TUI_VISUAL_DIR || join(tmpdir(), 'pixel-agents-tui-visual')
}
