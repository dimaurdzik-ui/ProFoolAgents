 ...
 * across theme x background scenes to <tmpdir>/pixel-agents-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@pixel-agents/ink'
...
// The regenerated slate light_colors block from pixel_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/pixel-agents',
...
const setup = (bgHex: string) => {
  process.env.PIXEL_AGENTS_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
