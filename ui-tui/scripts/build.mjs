...
await build({
  ...
  // Skip the prebuilt @pixel-agents/ink bundle and inline the source instead:
  ...
  alias: { '@pixel-agents/ink': resolve(root, 'packages/pixel-agents-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The pixel_cli launcher
